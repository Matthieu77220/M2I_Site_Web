...
function SuperAdminEquipements() {
    ...
    useEffect(() => {
        axios.get("/api/superAdminEquipement/stockChasuble", { withCredentials: true })
    ...
    // Catch : proctection des pages si status = 401
    useEffect(() => {
        axios.get("/api/superAdminEquipement/stockBallon", { withCredentials: true })
    ...
    // Catch : proctection des pages si status = 401
    useEffect(() => {
        axios.get("/api/superAdminEquipement/stockCrampon", { withCredentials: true })
